...
**DiGi.Solar.Rhino** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Solar.ComputeSharp.Rhino](DiGi.Solar.ComputeSharp.Rhino)** (Path: `DiGi.Solar.Rhino\DiGi.Solar.ComputeSharp.Rhino`)
* **[DiGi.Solar.Rhino](DiGi.Solar.Rhino)** (Path: `DiGi.Solar.Rhino\DiGi.Solar.Rhino`)
